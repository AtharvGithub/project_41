...
var player_img, enemy_img, Background_img, bullet_img, enemy_img1;
...
function setup() {
 ...
 player = createSprite(500, 770, 20, 20);
...
function draw() {
  ...
  imageMode(CENTER);
  image(enemy_img1, enemyGroup.x, enemyGroup.y, 70, 100);
...
function spawnEnemy1(){
  if(World.frameCount%67===0){
     ...
     enemyS.y = 50;
     imageMode(CENTER);
     image(enemy_img1, enemyS.x, enemyS.y, 70, 100);
    ...
    var enemyA = createSprite(100, 100, 20, 20);
    ...
    function spawnEnemy3(){
      if(World.frameCount%65===0){
        ...
        var enemyB = createSprite(100, 100, 20, 20);
    ...
    function spawnEnemy4(){
      if(World.frameCount%75===0){
        ...
        var enemyC = createSprite(100, 100, 20, 20);
    ...
    function spawnEnemy5(){
      if(World.frameCount%73===0){
        ...
        var enemyD = createSprite(100, 100, 20, 20);
